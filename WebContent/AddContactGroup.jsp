  ...
  <aside class="main-sidebar">
    ...
    <div style="position: relative; overflow: hidden; width: auto; height: 893px;" class="slimScrollDiv"><section style="height: 893px; overflow: hidden; width: auto;" class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="AddContactGroup.jsp"><i class="fa fa-users"></i> <span>Add Contact Group</span></a></li>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
						    <div class="form-area">
						        ...
						        <form id="form" method="post" role="form" action="add-contact-group">
				    				<div class="form-group">
										<input type="text" class="form-control" id="name" name="group_name" placeholder="Name of the group" required>
									</div>
									<div id="contactsList" class="form-group">
										<div class="input-group">
									      <input class="form-control" placeholder="Add contacts" type="text" disabled>
									      <span class="input-group-btn">
									      	<input id="nbContacts" name="nb_contacts" value="0" hidden/>
									        <button id="addContact" class="btn btn-secondary" type="button"><i class="fa fa-plus"></i></button>
									      </span>
									    </div>
									</div>
									</form>
...
<script src="./starter_fichiers/classie.js"></script>
<script>
				$("#nbContacts").val(""+$(".deleteContact").size());
				
				$("#addContact").click(function(){
					var nbConctacts =  $(".deleteContact").size();
					$("#contactsList").after('<div class="form-group col-md-12 phoneNumberField" >'
					+'<div class="col-md-5"><input name="phones['+nbConctacts+'].phoneKind" class="form-control" placeholder="DumbContact" type="text" ></div>'
					+'<div class="col-md-2"><button class="btn btn-secondary btn-danger deleteContact" type="button" onClick="deleteContact(event)"><i class="fa fa-times"></i></button></div>'
					+'</div>');
					$("#nbContacts").val(""+nbConctacts);
				});
				
				function deleteContact( event ){
					$(event.target).parents(".form-group").remove();
					$("#nbContacts").val(""+$(".deleteContact").size());
					console.log($("#nbContacts").val());
				}
		</script>
