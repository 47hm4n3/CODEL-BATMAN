<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
	import="java.util.List,com.gestioncontact.entities.Contact,com.gestioncontact.entities.Address,com.gestioncontact.entities.Enterprise,com.gestioncontact.entities.ContactGroup,com.gestioncontact.entities.PhoneNumber"
%>
			...
			<%}%>
				...
				function reorderPhonesList(){
					...
					phoneGroups.each(function( index ){
						...
						$( this ).find(".phoneId").attr("name", "phones["+index+"].phoneId");
					});
				}
		</script>
